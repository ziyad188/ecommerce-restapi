...
public class JwtTokenProvider {
    //this will give the value mentioned in aplications.properties file
    ...
    public boolean validateToken(String token){
        try{
            ...
            throw new ProductApiException(HttpStatus.BAD_REQUEST,"Unsuppoerted Jwt Token");
        }catch (IllegalArgumentException ex){
            throw new ProductApiException(HttpStatus.BAD_REQUEST,"Jwt claim string is empty");
        }
